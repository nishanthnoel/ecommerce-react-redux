...
// we dont need the color, size, in our front end detail page
// const colors = [
...
export default function ProductDetail() {
  ...
  // const [selectedSize, setSelectedSize] = useState(sizes[2]);  //initially we had giving default size and color. now we have removed that
  ...
  const handleCart = (e) => {
    ...
    if (items.findIndex((item) => item.product.id === product.id) < 0) {
      //productId has been changed to product.id when connecting to backend
      const newItem = {
    ...
    <div className="bg-white">
      {product && (
        <div className="pt-6">
          ...
          {/* Image gallery product.images[0] because no other images were available*/}
                ...
                {product.colors && product.colors.length > 0 && (
                  <div>
                    ...
                    <fieldset aria-label="Choose a color" className="mt-4">
                      ...
                      >
                        {/* product.colors && this was pu to make short circuiting. */}
