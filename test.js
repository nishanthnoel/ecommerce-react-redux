...
// const categories =[...new Set([...products.map(p=>p.category)] )]
// const c = categories.map(c=>({value:c, label:c.split("-").join(" "), checked: false}))
// c 
// const brands =[...new Set([...products.map(p=>p.brand)] )]
// brands.map(b=>({value:b, label:b.split("-").join(" "), checked: false}))
// const b = brands.map(b=>({value:b, label:b , checked: false}))
// b
