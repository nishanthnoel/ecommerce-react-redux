...
const addresses = [
  ...
  {
    name: "John Wick",
    street: "123 Phoenix Road, Sector 25",
    city: "Mumbai",
    state: "Maharashtra",
    pinCode: "400001",
    phone: "9876543210",
    email: "john.wick@mumbai.com",
  },
];
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-gray-100">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2 grid grid-cols-1">
                      <select
                        ...
                        className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900  border-gray-400 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                      >
        ...
        <div className="col-span-2">
          <div className="mx-auto mt-20 bg-white max-w-7xl px-0 sm:px-0 lg:px-0 rounded-md border border-transparent">
